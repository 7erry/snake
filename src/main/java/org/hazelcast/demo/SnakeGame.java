...
public class SnakeGame extends JFrame {
	...
	/**
	 * Make this a Multiplayer Game with Hazelcast
	 */
	...
	private SnakeGame() {
		...
		/**
		 * Hazelcast Server for local network games
		 */
	...
	private void startGame() {
		/**
		 * get the last score for this user
		 */
		lastScore = GameServer.getLastScore();
	...
	private void updateGame() {
		...
		if(collision == TileType.Fruit) {
			...
			isGameOver = true;
			// add last score to hazelcast
			lastScore = score;
			GameServer.putLastScore(lastScore);
			logicTimer.setPaused(true);
